...
open class ProfessorTitular( // Classe Professor Titular que herda de Professor
    nome: String,
    sobrenome: String,
    tempoDeCasa: Int,
    codProfessor: Int,
...
open class ProfessorAdjunto(  // Classe Professor Adjunto que herda de Professor
    nome: String,
    sobrenome: String,
    tempoDeCasa: Int,
    codProfessor: Int,
